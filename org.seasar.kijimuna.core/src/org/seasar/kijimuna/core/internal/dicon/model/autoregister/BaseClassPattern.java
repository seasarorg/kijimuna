...
public class BaseClassPattern {
	 ...
	 */
	public BaseClassPattern(String packageName, String shortClassNames) {
	...
	public void setShortClassNames(String shortClassNames) {
		String[] classNames = StringUtils.split(shortClassNames, ",");
	...
	public boolean isAppliedPackageName(String pName) {
		if (!StringUtils.isEmpty(pName) && !StringUtils.isEmpty(packageName)) {
