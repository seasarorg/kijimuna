 ...
 */
public class IncludeElement extends DiconElement implements IIncludeElement, ConstCore {
	...
	private IContainerElement getContainer(IStorage storage) {
		...
		if (nature != null) {
			...
			if (child != null) {
				model.addContainerAndRelatedFile(getParentContainer(), (IStorage) child
