...
public class MarkerSetting implements ConstCore {
	...
	public static void setDiconValidationPreference(
	        IProject project, boolean isValidation) {
	    IPreferences pref;
	    if(project == null) {
	        pref = KijimunaCore.getPreferences();
	    } else {
	...
	public static boolean getDiconValidationPreference(
			IProject project, boolean isDefault) {
	    IPreferences pref;
	    if(project == null) {
	        pref = KijimunaCore.getPreferences();
	    } else {
    ...
    public static void createDiconMarker(
    		String id, IDiconElement element, String message) {
    ...
    public static void createDiconMarker(
            String id, IDiconElement element, Object[] info) {
        createDiconMarker(id, element, KijimunaCore.getResourceString(id, info));
    }

    public static void createDiconMarker(
            String id, IDiconElement element) {
