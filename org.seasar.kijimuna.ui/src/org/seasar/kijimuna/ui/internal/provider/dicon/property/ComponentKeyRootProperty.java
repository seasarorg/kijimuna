...
public class ComponentKeyRootProperty extends NullProperty {
	...
	static {
		...
		PropertyDescriptor d = new PropertyDescriptor(COUNT_ID, KijimunaUI
				.getResourceString("dicon.provider.property.ComponentKeyRootProperty.1"));
		d.setCategory(KijimunaUI
				.getResourceString("dicon.provider.property.ContentProperty.4"));
		descriptors[0] = d;
		d = new PropertyDescriptor(TOOMANY_ID, KijimunaUI
				.getResourceString("dicon.provider.property.ComponentKeyRootProperty.2"));
		d.setCategory(KijimunaUI
				.getResourceString("dicon.provider.property.ContentProperty.4"));
		descriptors[1] = d;
		d = new PropertyDescriptor(NORMAL_ID, KijimunaUI
				.getResourceString("dicon.provider.property.ComponentKeyRootProperty.3"));
		d.setCategory(KijimunaUI
				.getResourceString("dicon.provider.property.ContentProperty.4"));
		descriptors[2] = d;
	}
