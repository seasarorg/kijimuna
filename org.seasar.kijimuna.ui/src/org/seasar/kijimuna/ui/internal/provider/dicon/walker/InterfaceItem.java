 ...
 */
public class InterfaceItem extends AbstractInternalContainer
		implements IHasJavaElement, ConstUI {

    private IRtti instanceRtti;
    private IRtti implemeniting;
    
    public InterfaceItem(IInternalContainer parent, 
            IRtti instanceRtti, IRtti implemeniting) {
        super(parent);
    ...
    public int getMarkerSeverity() {
        if(implemeniting instanceof HasErrorRtti) {
            ...
            return MarkerSetting.getDiconMarkerPreference(
                    project, MARKER_CATEGORY_JAVA_FETAL, false);
        }
