 ...
 */
public class ContentItem extends AbstractInternalContainer 
		implements ConstUI {

    private boolean isOutline;
    
    public ContentItem(
            IDiconElement element, IContentWalker parent, boolean isOutline) {
    ...
    public Object[] getChildren() {
        ...
        IComponentInfo info = (IComponentInfo)
        		getElement().getAdapter(IComponentInfo.class);
        if(info != null) {
	        ...
	        IApplyMethodInfo methodInfo = (IApplyMethodInfo)getElement().getAdapter(IApplyMethodInfo.class);
	        if(methodInfo != null) {
	            ...
	            IAspectInfo aspectInfo = (IAspectInfo)getElement().getAdapter(IAspectInfo.class);
		        if(aspectInfo != null) {
        ...
        for(Iterator it = children.iterator(); it.hasNext();) {
        	...
        	if(isOutline) {
        		...
        		if(obj instanceof IComponentElement) {
        			ret.add(new ContentItem(
        			        (IComponentElement)obj, this, false));
        		} else if(obj instanceof IIncludeElement) {
        			IContainerElement container = 
        			    ((IIncludeElement)obj).getChildContainer();
