 ...
 */
public class RelatedContainerItem extends AbstractContentWalker
		implements IExternalContainer, ConstUI {

    private IContainerElement relatedContainer;
    
    public RelatedContainerItem(
            IContainerElement relatedContainer,IContentWalker parent) {
        super(parent);
