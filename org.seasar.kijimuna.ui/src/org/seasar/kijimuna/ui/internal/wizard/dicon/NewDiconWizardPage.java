...
public class NewDiconWizardPage extends NewTypeWizardPage
    ...
    public void createControl(Composite parent) {
        ...
        versionLabel.setText(
                KijimunaUI.getResourceString("dicon.wizard.NewDiconWizardPage.5"));
	    ...
	    if(nameText != null) {
		    ...
		    if(StringUtils.noneValue(name)) {
				...
				try {
		    		...
		    		if (file.exists()) {
			            message = KijimunaUI.getResourceString("dicon.wizard.NewDiconWizardPage.13");
		    		} else {
						severity = IStatus.OK;
		    		}
    ...
    public boolean createDiconFile() {
        ...
        String dicon = 
            KijimunaUI.getResourceString(
                    "dicon.wizard.NewDiconWizardPage.10", new Object[] { enc }) +
            KijimunaUI.getResourceString(
                    "dicon.wizard.NewDiconWizardPage.11", new Object[] { publicId, systemId }) +
            KijimunaUI.getResourceString(
                    "dicon.wizard.NewDiconWizardPage.12");
        try {
